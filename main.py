"""
DAOpilot — AI assistant for DAO governance and proposal drafting
...
log = logging.getLogger("daopilot")
...
class Router:
    """Cost- and latency-aware model router for DAOpilot."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="DAOpilot: AI assistant for DAO governance and proposal drafting")
